...
int pageTableNumbers1[PAGE_TABLE_SIZE];  // array to hold the page numbers in the page table
int pageTableFrames1[PAGE_TABLE_SIZE];   // array to hold the frame numbers in the page table

int TLBPageNumber1[TLB_SIZE];  // array to hold the page numbers in the TLB
int TLBFrameNumber1[TLB_SIZE]; // array to hold the frame numbers in the TLB

int physicalMemory1[TOTAL_NUMBER_OF_FRAMES][FRAME_SIZE]; // physical memory 2D array
